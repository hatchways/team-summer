...
export default (globalAppState) => {
  ...
  if (jwtToken) {
    try {
      ...
      globalAppState.userDetails = { name: data.name, id: data._id, location: data.location, about: data.about };
      globalAppState.userDetails.avatar = localStorage.getItem('profilePic');
